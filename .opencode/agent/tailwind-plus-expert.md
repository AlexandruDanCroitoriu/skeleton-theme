---
description: >-
  Use this agent when a user asks about Tailwind Plus:
  utilities, configuration, responsive variants, dark mode, theming, plugins,
  installation, troubleshooting why a class doesn't apply, or differences
  between Tailwind versions. Also use it when a task involves adding or
  reviewing Tailwind/Tailwind Plus code, or when you need authoritative
  references from Tailwind/Tailwind Plus markdown docs.
mode: subagent
tools:
  bash: false
  read: true
