...
try {
  document.body && document.body.setAttribute("data-js-enhanced", "");
} catch {
}
...
async function fetchCart() {
  ...
  try {
    ...
    state.cart = data;
    state.count = (data == null ? void 0 : data.item_count) || 0;
    state.error = null;
...
async function changeLine({ id, quantity, line, _idx } = {}) {
  ...
  if (res.ok) {
    ...
    const message = (data == null ? void 0 : data.message) || (data == null ? void 0 : data.description) || (Array.isArray(data == null ? void 0 : data.errors) ? data.errors.join(", ") : typeof (data == null ? void 0 : data.errors) === "string" ? data.errors : "Cart update failed");
    state.error = message;
...
async function addLine({ id, quantity = 1, properties } = {}) {
  ...
  if (res.ok) {
    ...
    const message = (data == null ? void 0 : data.message) || (data == null ? void 0 : data.description) || "Add to cart failed";
    state.error = message;
    document.dispatchEvent(new CustomEvent("cart:add:error", { detail: { message, data } }));
    return { ok: false, error: message, data };
  }
}
const cartStore = { state, fetchCart, changeLine, addLine };
function enhanceProductForms() {
  var _a;
  (_a = document.querySelectorAll("form[data-ajax-product-form]")) == null ? void 0 : _a.forEach((form) => {
    ...
    const App = {
      ...
      setup() {
        ...
        const formatMoney = (cents) => {
          var _a;
          try {
            const currency = ((_a = state.cart) == null ? void 0 : _a.currency) || "USD";
            const nf = new Intl.NumberFormat(void 0, { style: "currency", currency });
...
function mountHeaderFlyout() {
  document.querySelectorAll("[data-vue-cart-flyout]").forEach((el) => {
    ...
    const App = {
      ...
      setup() {
        ...
        const openPanel = async () => {
          ...
          open.value = true;
          await nextTick();
          (_a2 = panelRef.value) == null ? void 0 : _a2.focus();
        };
        onMounted(() => {
        ...
        const toggle = async () => {
          ...
          if (open.value) {
            ...
            (_b = buttonRef.value) == null ? void 0 : _b.focus();
          }
        };
        const formatMoney = (cents) => {
          var _a2;
          try {
            const currency = ((_a2 = state.cart) == null ? void 0 : _a2.currency) || "USD";
            const nf = new Intl.NumberFormat(void 0, { style: "currency", currency });
            return nf.format((cents || 0) / 100);
          } catch {
            return `$${((cents || 0) / 100).toFixed(2)}`;
    ...
    createApp(App).mount(el);
    const link = ((_a = el.previousElementSibling) == null ? void 0 : _a.matches("[data-cart-link]")) ? el.previousElementSibling : null;
